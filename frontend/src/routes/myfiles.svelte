...
<div class="container-fluid mx-auto">
  ...
  <div class="row">
        ...
        {#each own_algorithms as file}
          <div style="height: 40px">
            ...
            <button
              ...
              on:click={() => alert(`Can not withdraw access to algorithm from here. Please do it directly via ResearchDrive`)}>
              Revoke
            </button>
          </div>
        {:else}
    ...
    <div class="col border">
      ...
      <p>
        <b>5.</b>
        Refresh this page to see your file as being shared
      </p>
    </div>
  </div>
